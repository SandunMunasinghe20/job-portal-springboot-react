...
export default function MyProfile() {
  ...
  const profileData = {
    ...
    summary:
      "Passionate fullstack developer with 3+ years of experience in modern web technologies. Specialized in React, Node.js, and cloud technologies. I create innovative solutions that bridge the gap between creative design and robust functionality, delivering exceptional user experiences through clean, efficient code.",
    ...
    featuredProjects: [
      ...
      },
      {
        ...
        description:
          "Responsive portfolio website with animations and optimized performance.",
      },
    ],
  ...
  const SkillTag = ({ skill, category }) => (
    <span className={`skill-tag ${category}`}>{skill}</span>
  );
        ...
        <div className="hero-section">
          <div className="hero-content">
            <div className="hero-text">
              ...
              <p className="job-description">{profileData.summary}</p>
              <div className="contact-info">
                <ContactInfo icon="📍" text={profileData.location} />
                <ContactInfo
                  icon="💼"
                  text={`${profileData.yearsExp} Years Experience`}
                />
